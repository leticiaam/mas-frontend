            ...
            <Container>
                ...
                <form onSubmit={onSubmit}>
                    <input 
                        ...
                        />
                        {errors.courseunit && <Error> O preenchimento do campo é obrigatória</Error> }
                    <input 
                        type="text"
                        placeholder="Atividade"
                        {...register("activy", {required:true})}
                         />
                         {errors.activy && <Error> O preenchimento do campo é obrigatória</Error> }
                    <input 
                        type="date"
                        placeholder="Data da Atividade"
                        {...register("date", {required:true})}
                        />
                        {errors.date && <Error> O preenchimento do campo é obrigatória</Error> }
                    <button type="submit">
                        Cadastrar
                    </button>
